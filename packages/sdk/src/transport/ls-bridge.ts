...
export class LSBridge {
  ...
  private async _sendMessage(
    ...
    // ProtoJSON format: oneof fields use the selected field name directly as key.
    ...
    // oneof plannerTypeConfig: set the selected variant as a direct key
    const variant = plannerType || 'conversational';
    plannerConfig[variant] = {};
